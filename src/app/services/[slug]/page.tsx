          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-8 py-2.5 sm:py-3 flex items-center justify-between gap-2 sm:gap-3">
            <div className="hidden sm:flex items-center gap-4 text-xs text-slate-500 shrink-0">
              ...
              <span className="hidden lg:flex items-center gap-1.5">
                ...
                <span className="font-semibold whitespace-nowrap">Trusted by 500+ customers</span>
              </span>
            </div>
            <div className="flex items-center gap-2 w-full sm:w-auto">
              <a
                ...
                className="inline-flex items-center justify-center flex-1 sm:flex-none whitespace-nowrap px-3.5 sm:px-4 py-2 text-xs font-extrabold text-white bg-emerald-600 hover:bg-emerald-700 rounded-lg shadow-xs transition-colors"
              >
                <svg className="w-3.5 h-3.5 mr-1.5 fill-current shrink-0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <a
                href="#quote-form"
                className="inline-flex items-center justify-center flex-1 sm:flex-none whitespace-nowrap px-3.5 sm:px-4 py-2 text-xs font-extrabold text-primary bg-primary-light hover:bg-primary hover:text-white border border-primary/20 rounded-lg transition-colors"
              >
                Get Quote
              </a>
            </div>
