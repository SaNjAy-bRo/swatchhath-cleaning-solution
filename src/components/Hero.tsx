...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden min-h-[70vh] sm:min-h-0 flex items-center bg-[#162659] bg-[url('/images/hero-cartoon-mobile.png')] md:bg-[url('/images/hero-cartoon-desktop.png')] bg-contain bg-no-repeat bg-bottom md:bg-right-bottom">
      {/* Rich blue overlay (gradient from dark navy blue to transparent, showing the cartoon illustration) */}
      <div className="absolute inset-0 bg-gradient-to-r from-[#162659]/90 via-[#162659]/50 to-transparent z-0" />
