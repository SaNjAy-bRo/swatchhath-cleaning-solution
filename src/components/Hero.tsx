      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 w-full">
        <div className="grid md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-7 flex flex-col items-center text-center sm:items-start sm:text-left justify-center space-y-6 max-w-xl">
            <div className="inline-flex items-center space-x-1.5 bg-primary-light text-primary-hover px-3 py-1 rounded-full text-xs font-extrabold w-fit tracking-wider">
            ...
            <h1 className="font-heading text-3xl sm:text-4xl lg:text-5.5xl font-black tracking-tight text-slate-900 leading-tight">
              Keep Your Space <br className="hidden sm:inline" />
              <span className="text-primary">Spotless & Healthy</span>
            </h1>
            ...
            <div className="hidden sm:flex flex-row flex-wrap items-center gap-3 pt-1 w-full">
              <div className="flex items-center space-x-2 bg-white/90 border border-slate-200/60 px-3.5 py-1.5 rounded-full shadow-3xs w-fit">
                <ShieldCheck className="h-4.5 w-4.5 text-emerald-600 shrink-0" />
                <span className="text-xs text-slate-800 font-bold">Verified Professionals</span>
              </div>
              <div className="flex items-center space-x-2 bg-white/90 border border-slate-200/60 px-3.5 py-1.5 rounded-full shadow-3xs w-fit">
                <Zap className="h-4.5 w-4.5 text-primary shrink-0" />
                <span className="text-xs text-slate-800 font-bold">Eco-Friendly Sanitizers</span>
              </div>
            </div>
            ...
            <div className="flex flex-row items-center justify-center sm:justify-start gap-3.5 pt-2 w-full sm:w-auto">
              <a
                ...
                className="inline-flex items-center justify-center px-6 py-3.5 text-sm font-bold rounded-lg text-white bg-emerald-600 hover:bg-emerald-700 shadow-sm hover:shadow-md transition-all duration-200"
              >
          ...
          <div className="hidden md:block md:col-span-5 relative">
            <div className="bg-white/95 backdrop-blur-xs rounded-2xl border border-slate-100 p-5.5 shadow-lg max-w-sm mx-auto relative">
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="inline-flex items-center text-xs font-bold text-emerald-600 bg-emerald-50 px-2.5 py-0.5 rounded-sm">
                  Active
                </span>
              </div>
              <ul className="space-y-4">
                <li className="flex items-start space-x-3.5">
                  <div className="flex-shrink-0 h-5.5 w-5.5 rounded-full bg-primary-light text-primary flex items-center justify-center font-bold text-xs">
                    ✓
                  </div>
                  <div>
                    <h3 className="text-sm font-extrabold text-slate-800">High-Pressure Wash</h3>
                    <p className="text-xs text-slate-500">Decks, walkways, walls, and solar setups.</p>
                  </div>
                </li>
                <li className="flex items-start space-x-3.5">
                  <div className="flex-shrink-0 h-5.5 w-5.5 rounded-full bg-primary-light text-primary flex items-center justify-center font-bold text-xs">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">Thorough sanitization for pure water storage.</p>
                  </div>
                </li>
                <li className="flex items-start space-x-3.5">
                  <div className="flex-shrink-0 h-5.5 w-5.5 rounded-full bg-primary-light text-primary flex items-center justify-center font-bold text-xs">
              ...
              <div className="mt-4 pt-4 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
                <span>📍 Transport at actuals</span>
